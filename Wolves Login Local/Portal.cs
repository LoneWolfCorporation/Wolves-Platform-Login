...
namespace Wolves_Login_Local
{
    public partial class Portal : UserControl
    {
        ...
        private void LoginEvent_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (!Directory.Exists(UserFolder))
            {
                ...
                this.Invoke(new Action(() => {
                    ...
                    LogLabel.Text = "THE USER YOU'VE PROVIDED IS NOT A MEMBER OF WOLVES PLATFORM.";
                }));
            }
        ...
        {
            if (Program.WL.Panel_Register.Visible == false)
            {
                Program.WL.Panel_Portal.Visible = false;
                Program.WL.Panel_Portal.SendToBack();
                Program.WL.Panel_Register.Visible = true;
                Program.WL.Panel_Register.BringToFront();
            }            
        }
    }
}
